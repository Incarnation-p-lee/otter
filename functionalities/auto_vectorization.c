...
static NO_INLINE void show_integer_average_auto_vectorization(
    uint8 *dst, uint32 dst_stride, uint8 *src_1, uint32 src_1_stride,
    uint8 *src_2, uint32 src_2_stride, uint32 width, uint32 height) {
